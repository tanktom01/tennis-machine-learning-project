...
def main():
    ...
    ## Initalize Model
    player_tracker = PlayerTracker(model_path="models/yolo11x")
    ...
    # Court Line Dectector
    ## Read Paths
    court_model_path = "models/keypoints_model_v3.pth"
    ...
    for ball_shot_ind in range(len(ball_shot_frames) - 1):
        ...
        ball_shot_time_in_seconds = (
            end_frame - start_frame
        ) / 24  # Video is shot in 24 fps

        # get Distance of ball travel
        ...
        # Adding player stats to data structure (dictionary)
    ...
    ## Draw fram number on top left corner
