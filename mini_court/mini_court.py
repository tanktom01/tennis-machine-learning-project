...
class MiniCourt:
    ...
    def get_mini_court_coordinates(
        ...
        # Get the Distance (x,y) between closest keypoint and player
        distance_from_keypoints_x_pixels, distance_from_keypoints_y_pixels = (
            measure_xy_distance(object_position, closest_key_point)
        )

        # Convert pixel distance to meters
        """ This will get the meters a player travelled in the game"""
        distance_from_keypoint_x_meters = convert_meters_to_pixels_distance(
            distance_from_keypoints_x_pixels,
            player_height_in_pixels,
            player_height_in_meters,
        )
        distance_from_keypoint_y_meters = convert_meters_to_pixels_distance(
            distance_from_keypoints_y_pixels,
            player_height_in_pixels,
            player_height_in_meters,
        )
        ...
        # Add distance in Pixels to get the position
